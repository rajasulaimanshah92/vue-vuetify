            ...
            <v-flex xs12>
                ...
                <v-dialog v-model="dialog" max-width="600px" class="d-block">
                    ...
                    <v-card>
                        ...
                        <v-card-text v-if="internal == false" class="pa-0">
                                ...
                                <v-layout wrap row>
                                    ...
                                    <v-flex xs12 sm6 md6 px-2>
                                        <v-menu
                                            ...
                                            :nudge-right="40"
                                            :return-value.sync="editedItem.availability"
                                        ...
                                        >
                                            ...
                                            <v-time-picker
                                                v-model="editedItem.availability"
                                                full-width
                                                @click:minute="$refs.timeMenu1.save(editedItem.availability)"
                                            ></v-time-picker>
                                        </v-menu>
                                    </v-flex>
                                    <v-flex xs12 sm6 md6 px-2>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn text small class="elevation-0" color="primaryGreen" @click="close">Cancel</v-btn>
                        ...
                        <v-card-text v-else class="pa-0">
                                ...
                                <v-layout wrap row>
                                    ...
                                    <v-flex xs12 sm6 md6 px-2>
                                        <v-menu
                                            ...
                                            :close-on-content-click="false"
                                            :nudge-right="40"
                                            :return-value.sync="editedInternalItem.availability"
                                            transition="scale-transition"
                                            offset-y
                                            max-width="290px"
                                            min-width="290px"
                                        >
                                            ...
                                            <v-time-picker
                                                v-model="editedInternalItem.availability"
                                                full-width
                                                @click:minute="$refs.timeMenu2.save(editedInternalItem.availability)"
                                            ></v-time-picker>
                                        </v-menu>
                                    </v-flex>
                                    <v-flex xs12 sm6 md6 px-2>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn small text dark depressed color="primaryGreen" @click="close">Cancel</v-btn>
                                <v-btn
                                    :loading="isLoading"
                                    small
                                    dark
                ...
                <v-dialog persistent v-model="delDialog" max-width="500px">
                    <v-card class="pa-3">
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn text dark small color="primaryGreen" @click="close">Cancel</v-btn>
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-container class="pb-0" grid-list-xs,md>
                                ...
                                <v-card-actions>
                                    <v-spacer></v-spacer>
                                    <v-btn text small class="elevation-0" color="primaryGreen" @click="exportDialog = false"
                                        >Cancel</v-btn
                                    >
    ...
    methods: {
        ...
        generateExcel() {
            ...
            if (this.internal === true) {
                this.resourcesTableData.forEach((el, index) => {
                    forExcel.push({
                        No: index + 1,
