    ...
    methods: {
        ...
        updateChart(nodeId) {
            ...
            const updatedNode = {
                ...
                tag: tag,
                tags: tags,
                team: this.currEmergencyTeam,
                title: this.title,
                titledescription: this.description,
            }

            axios
                .post(`${process.env.VUE_APP_API_URL}/organization/edit`, updatedNode, {
                    headers: {
        ...
        createChart(team, chartType, chartData) {
            ...
            this.chart = new OrgChart(this.$refs.chartcontainer, {
                ...
                onAdd(sender, node) {
                    ...
                    axios
                        .post(`${process.env.VUE_APP_API_URL}/organization/add`, newNode, {
                            headers: {
                ...
                onRemove(sender, nodeId) {
                    if (VM.orgChartData.length <= 1) {
                        ...
                        axios
                            .get(`${process.env.VUE_APP_API_URL}/organization/delete/${nodeId}`, {
                                headers: {
                                    Authorization: 'Bearer ' + VM.$store.getters.user.token,
                                },
                            })
        ...
        loadChartData(facility, team) {
            axios
                .get(`${process.env.VUE_APP_API_URL}/organization/${facility}?team=${team}`, {
                    headers: {
                        Authorization: 'Bearer ' + this.$store.getters.user.token,
                    },
                })
