                ...
                <v-card>
                    <editor-menu-bar :editor="editor" v-slot="{ commands, isActive }">
                        <v-card-title class=" my-0 py-0 grey lighten-4">
                            ...
                            <v-btn icon :color="isActive.bold() === true ? 'grey lighten-2' : ''" @click="commands.bold">
                                <v-icon>mdi-format-bold</v-icon>
                            </v-btn>

                            <v-btn icon :color="isActive.italic() === true ? 'grey lighten-2' : ''" @click="commands.italic">
                                <v-icon>mdi-format-italic</v-icon>
                            </v-btn>

                            <v-btn icon :color="isActive.strike() === true ? 'grey lighten-2' : ''" @click="commands.strike">
                            ...
                            <v-btn icon :color="isActive.code() === true ? 'grey lighten-2' : ''" @click="commands.code">
                            ...
                            <v-btn icon @click="commands.createTable({ rowsCount: 3, colsCount: 3, withHeaderRow: true })">
