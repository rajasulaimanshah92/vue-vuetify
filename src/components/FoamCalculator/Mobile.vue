    ...
    <div>
        <v-card flat class="pa-5">
            <v-card-text class="mt-5">
                <h1 class="primaryGreen--text">Foam application estimator for full surface tank fires using mobile equipment</h1>
            </v-card-text>
        </v-card>
        <v-layout row wrap>
            <v-flex xs12 md4>
        ...
        <v-card tile color="primaryGreen" class="px-5 pb-5">
            <v-card-text>
                ...
                <p class="mb-0 white--text">
                    0.26 US LPM/m² foam premix per square foot (10.4 GPM/m² minute per square metre)<br />
                </p>
                <h4 class="pt-3 white--text">Application Time:</h4>
                <p class="mb-0 white--text">65 minutes<br /></p>
                <div class="pt-3">
                    <div style="background-color: #fff; border: 2px solid black;">
                        <p style="margin: 12px;">
                            When using portable/mobile foam monitor, it is recommended to plan for a foam rate production at grade
                            level of 10.4 l/min/m2 (0.26gpm/ft2) which is an increase by 60% of minimum NFPA rates. This allows
                            for the loss of foam which fails to reach the tank interior and breaks down due to heat and thermal
                            currents (the latter have been recorded upwards of 80 km/hr - 50mph), inexpert operation of monitors
                            and variations in wind speed/direction. Recent major fires have confirmed that application rates at
                            least 8.5 l/min/m2 (0.21 gpm/ft2) were necessary.
                        </p>
                    </div>
                </div>
            </v-card-text>
    ...
    data() {
        return {
            ...
            calculator: {
                ...
                tankDiameterImp: 197,
                concentration: '1',
                applicationRate: 10.4,
                applicationRateImp: 0.26,
                duration: 65,
                flowPremix: null,
